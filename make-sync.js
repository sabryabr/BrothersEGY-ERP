...
const t1 = '\u0635\u0641\u062d\u0629 \u0627\u0644\u0625\u062f\u062e\u0627\u0644\u0627\u062a \u0644\u0642\u0627\u0639\u062f\u0629 \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a';
const t2 = '\u0635\u0641\u062d\u0629 \u0627\u0644\u0625\u062f\u062e\u0627\u0644\u0627\u062a \u0644\u0644\u0625\u064a\u062c\u0627\u0631\u0627\u062a';
...
'',
'const SHEETS={',
'  cars:{id:"1tQVkPj7tCnrKsHEIs04a1WzzC04jpOWuLsXgXOkVMkk",tab:"' + t1 + '",collection:"fleet",idCol:0,minFields:2},',
'  orders:{id:"1T6j2xnRBTY31crQcJHioKurs4Rvaj-VlEQkm6joGxGM",tab:"' + t2 + '",collection:"bookings",idCol:0,minFields:3},',
'  clients:{id:"13YZOGdRCEy7IMZHiTmjLFyO417P8dD0m5Sh9xwKI8js",tab:"' + t1 + '",collection:"customers",idCol:0,minFields:2},',
'  collections:{id:"1jtp-ihtAOt9NNHETZ5muiL5OA9yW3WrpBIIDAf5UAyg",tab:"' + t1 + '",collection:"collections",idCol:null,minFields:2},',
'  car_expenses:{id:"1vDKKOywOEGfmLcHr4xk7KMTChHJ0_qquNopXpD81XVE",tab:"' + t1 + '",collection:"car_expenses",idCol:null,minFields:2},',
'  gen_expenses:{id:"1hZoymf0CN1wOssc3ddQiZXxbJTdzJZBnamp_aCobl1Q",tab:"' + t1 + '",collection:"gen_expenses",idCol:null,minFields:2}',
'};',
'',
...
fs.writeFileSync('sync-sheets.js', lines.join('\n'), 'utf8');
console.log('sync-sheets.js written OK');
console.log('Lines:', lines.length);
console.log('Line 1:', lines[0]);
console.log('Line 45:', lines[44]);
